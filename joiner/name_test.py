...
def test_pedigree_names():
    ...
    assert sorted(extractor.extract()) == sorted({
        Name("foo", Namespace.PEDIGREE): [Signal(SignalName.PEDIGREE_NAME, "foo")],
        Name("bar", Namespace.PEDIGREE): [Signal(SignalName.PEDIGREE_NAME, "bar")],
    })
...
def test_europotato_pedigree_names_success():
    ...
    assert sorted(extractor.extract()) == sorted({
        Name("woo", Namespace.PEDIGREE): [Signal(SignalName.EUROPOTATO_NAME, "foo")],
        Name("yay", Namespace.PEDIGREE): [Signal(SignalName.EUROPOTATO_NAME, "bar")],
    })
